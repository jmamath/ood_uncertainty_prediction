...
def plot_distance_to_acc(distance, accuracies):
    ...
    # plt.savefig("MNIST-C-1norm", dpi=200)
    plt.show()

def plot_atc_differences(estimation, accuracies):
    ...
    plt.xlabel("ATC")
    plt.title("Loss of performance as dataset shifts")
    # plt.savefig("MNIST_C_ATC", dpi=200)
    plt.show()
...
plot_distance_to_acc(h_distances, accuracies)
plot_distance_to_acc(-labelwise_h_distances, accuracies)
plot_atc_differences(atc, accuracies)
